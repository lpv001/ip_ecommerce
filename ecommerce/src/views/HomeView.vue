<template>
  ...
  <main>
    <section id="banner">
      <h1>HOT SALE IN THIS SUMMER SEASON</h1>
      <p>Offer 50% off to all new customer visiting our SHOP</p>
      <button>START SHOPPING</button>
    </section>
    <section id="ship">
      <h1>Free Shipping For You Till Midnight</h1>
      <i>
    ...
    <section id="list">
      <div class="title">
        <h2>Flipstart Deals Of The Day</h2>
